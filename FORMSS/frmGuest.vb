    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            ...
            If validation = vbYes Then
                ...
                WriteToAuditTrail(_username, _role, $"Deleted guest: {txtName.Text}, Guest ID: {txtID.Text}")
            End If
            con.Close()
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            If btnClick = "Add" Then
                ...
                WriteToAuditTrail(_username, _role, $"Started adding new guest: {txtName.Text}")
            ElseIf btnClick = "Edit" Then
                ...
                WriteToAuditTrail(_username, _role, $"Started editing guest: {txtName.Text}")
            End If

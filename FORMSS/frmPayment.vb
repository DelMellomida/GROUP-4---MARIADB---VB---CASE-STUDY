    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            ...
            If validation = vbYes Then
                ...
                WriteToAuditTrail(_username, _role, $"Deleted payment:  {txtHolder.Text}, Reservation ID: {cmbRID.Text}, Reservation Payment ID: {txtRPID.Text}")
            End If
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            If btnClick = "Add" Then
                ...
                WriteToAuditTrail(_username, _role, $"Added new payment: {txtHolder.Text}, Reservation ID: {cmbRID.Text}, Reservation Payment ID: {txtRPID.Text}")
            ElseIf btnClick = "Edit" Then
                ...
                WriteToAuditTrail(_username, _role, $"Updated payment: {txtHolder.Text}, Reservation ID: {cmbRID.Text}, Reservation Payment ID: {txtRPID.Text}")
            End If

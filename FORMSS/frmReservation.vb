    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            ...
            If validation = vbYes Then
                ...
                WriteToAuditTrail(_username, _role, $"Deleting reservation: {cmbGID.Text}, Reservation ID: {txtRID.Text}")
            End If
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            If btnClick = "Add" Then
                ...
                WriteToAuditTrail(_username, _role, $"Added new reservation: {cmbGID.Text}, Reservation ID: {txtRID.Text}")
            ElseIf btnClick = "Edit" Then
                ...
                WriteToAuditTrail(_username, _role, $"Updating reservation: {cmbGID.Text}, Reservation ID: {txtRID.Text}")
            End If

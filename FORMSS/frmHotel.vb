        ...
        Try
            ...
            If Not id = 0 Then
                ...
                If validation = vbYes Then
                    ...
                    WriteToAuditTrail(_username, _role, $"Deleted hotel:  {txtName.Text}, ID: {id}")
                End If
            End If
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            If btnClick = "Add" Then
                ...
                WriteToAuditTrail(_username, _role, $"Added New hotel:  {txtName.Text}, Type: {cmbType.Text}")
            ElseIf btnClick = "Edit" Then
                If Not id = 0 Then
                    ...
                    WriteToAuditTrail(_username, _role, $"Edited hotel ID: {id}, New Name: {txtName.Text}, Type: {cmbType.Text}")
                Else

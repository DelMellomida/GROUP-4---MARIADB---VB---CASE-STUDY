    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            ...
            If validation = vbYes Then
                ...
                WriteToAuditTrail(_username, _role, $"Deleted user {txtUsername.Text}: Name - {txtName.Text}, Email - {txtEmail.Text}")
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If btnClick = "Add" Then
                ...
                WriteToAuditTrail(_username, _role, $"Added New user: Username - {txtUsername.Text}, Name - {txtName.Text}, Email - {txtEmail.Text}, Role - {txtRole.Text}")
            ...
            ElseIf btnClick = "Edit" Then
                ...
                ' Write to the audit trail
                WriteToAuditTrail(_username, _role, $"Updated user ID {id}: Username - {txtUsername.Text}, Name - {txtName.Text}, Email - {txtEmail.Text}, Role - {txtRole.Text}")
            End If
